...
public class registerController {
	...
	public String register(ModelMap model, @ModelAttribute("user") User user, @RequestParam("username")String username, @RequestParam("email")String to, 
		...
		String sql = "EXEC SP_KTTRUNGUSERNAME '" + user.getUsername() + "'";
		...
		if(user.getUsername().trim().length() < 8) {
			...
			errors.rejectValue("username", "user", "tai khoan da duoc su dung");
		}
