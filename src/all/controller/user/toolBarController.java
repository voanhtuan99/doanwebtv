...
public class toolBarController {
	...
	public String isNew(ModelMap model, HttpSession http) {
	...
	public String isSelling(ModelMap model, HttpSession http) {
	...
	@RequestMapping("ios")
	public String ios(ModelMap model, HttpSession http) {
	...
	public String android(ModelMap model, HttpSession http) {
